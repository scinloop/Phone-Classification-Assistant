...
def get_files(file_dir, ratio):
    for file in os.listdir(file_dir + '/xiaomi'):
        roses.append(file_dir + '/xiaomi' + '/' + file)
        label_roses.append(0)
    for file in os.listdir(file_dir + '/oppo'):
        tulips.append(file_dir + '/oppo' + '/' + file)
        label_tulips.append(1)
    for file in os.listdir(file_dir + '/vivo'):
        dandelion.append(file_dir + '/vivo' + '/' + file)
        label_dandelion.append(2)
    for file in os.listdir(file_dir + '/apple'):
        sunflowers.append(file_dir + '/apple' + '/' + file)
